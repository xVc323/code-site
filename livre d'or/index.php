...
//on v�rifie si $_GET['page']  existe (si la personnne veut afficher une autre page)
if (isset($_GET['page'])) {
	$page = $_GET['page'] ;
}
else {
...
//on compte le nombre de messages pr�sents dans la base
if ($nbre_erreur == 0) {
...
<?php
if($connexion) {
	if($base) {// on lib�re l'espace m�moire allou� pour ces requ�tes
