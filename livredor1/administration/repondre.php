...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		<title>R&eacute;ponse &agrave; un message du livre d'or</title>
	</head>
	<body>
	<h1>R&eacute;ponse au message</h1>
...
// on affiche la date de la réponse 
	echo 'a post&eacute; le ' , $donnee_sql_1['date'] , '<br />' ;
...
// on affiche le message à modifier
	...
	echo 'R&eacute;ponse du Webmaster : <br /><textarea name="reponse_webmaster" rows="8" cols="45">' , $donnee_sql_1['reponse_webmaster'] , '</textarea>' ;
?>
	<br />
